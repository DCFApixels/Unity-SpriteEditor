...
assert.match(api, /Number\(value, "strength", layer\.strength, 0f, BlurLayer\.MaximumStrength\)/);
...
assert.match(read('src/Automation/SpriteEditorApi.Inspect.cs'), /BlurSnapshot\(new BlurLayer\(\)\)/);
