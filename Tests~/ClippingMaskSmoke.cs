...
void Stack(params DCFApixels.SpriteEditor.Layer[] layers)
{
...
UnityEngine.Color Coverage(DCFApixels.SpriteEditor.Layer layer)
{
...
try
{
    ...
    upper.opacity = 1;
    foreach (DCFApixels.SpriteEditor.BlendMode mode in System.Enum.GetValues(typeof(DCFApixels.SpriteEditor.BlendMode)))
    {
        upper.blendMode = mode;
        Near(Pixel().a, .1f, "Base alpha preserved with " + mode);
    }
    upper.blendMode = DCFApixels.SpriteEditor.BlendMode.Overwrite;
    ...
    upper.blendMode = DCFApixels.SpriteEditor.BlendMode.Normal;
    ...
    basis.swizzle[3] = DCFApixels.SpriteEditor.SwizzleChannel.Zero;
    ...
    upper.colorRange = DCFApixels.SpriteEditor.LayerColorRange.HDR;
    upper.blendRange = DCFApixels.SpriteEditor.LayerBlendRange.HDR;
    basis.blendRange = DCFApixels.SpriteEditor.LayerBlendRange.HDR;
    ...
    upper.colorRange = DCFApixels.SpriteEditor.LayerColorRange.Standard;
    upper.blendRange = basis.blendRange = DCFApixels.SpriteEditor.LayerBlendRange.Standard;
    upper.color = UnityEngine.Color.blue;
    ...
    Check(DCFApixels.SpriteEditor.SpriteEditorApi.Describe().Contains("clippingMask"), "Agent discovery documents clipping");
    ...
    Stack(upper, basis);
    var all = new System.Collections.Generic.List<DCFApixels.SpriteEditor.Layer> { upper, basis };
    ...
    plan = createPlan.Invoke(doc, new object[] { new System.Collections.Generic.List<DCFApixels.SpriteEditor.Layer> { upper } });
    ...
    plan = createPlan.Invoke(doc, new object[] { new System.Collections.Generic.List<DCFApixels.SpriteEditor.Layer> { upper, lower } });
    merged = (UnityEngine.Texture2D)rasterizeMerge.Invoke(doc, new object[] { plan });
    owned.Add(merged);
