...
const brush = read('src/Layers/DrawingLayer.Brush.cs');
...
assert.ok(read('src/Layers/DrawingLayer.cs').includes('new Vector4(dabSize, dabColor.a, stamp.rotation, stamp.flip)'));
assert.ok(read('src/Layers/DrawingLayer.BrushMesh.cs').includes('List<Vector4> meshStamps'));
