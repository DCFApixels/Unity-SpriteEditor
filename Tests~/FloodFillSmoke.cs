...
var checks = 0;
var fillType = typeof(DCFApixels.SpriteEditor.DrawingLayer).Assembly.GetType("DCFApixels.SpriteEditor.FloodFillUtility", true);
...
Check(new DCFApixels.SpriteEditor.DrawingLayer().fillContiguous, "New layers keep connected fill by default");
Check(new DCFApixels.SpriteEditor.DrawingLayer().fillSampleMode == DCFApixels.SpriteEditor.FillSampleMode.CurrentLayer,
