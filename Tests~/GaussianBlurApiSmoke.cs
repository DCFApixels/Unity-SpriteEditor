...
var layer=new DCFApixels.SpriteEditor.BlurLayer();int checks=0;
...
Check(layer.strength==1 && layer.radius==8 && layer.edges==DCFApixels.SpriteEditor.BlurLayer.EdgeMode.Transparent,"Defaults");
Set("{\"radius\":32.5,\"edges\":\"Repeat\"}");Check(layer.radius==32.5f && layer.edges==DCFApixels.SpriteEditor.BlurLayer.EdgeMode.Repeat,"Set parameters");
...
var copy=new DCFApixels.SpriteEditor.BlurLayer();setter.Invoke(null,new object[]{copy,snapshot.Invoke(null,new object[]{layer})});
