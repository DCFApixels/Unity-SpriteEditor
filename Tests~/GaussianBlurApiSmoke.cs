...
var layer=new DCFApixels.SpriteEditor.BlurLayerBehaviour();int checks=0;
...
Check(layer.strength==1 && layer.radius==8 && layer.edges==DCFApixels.SpriteEditor.BlurLayerBehaviour.EdgeMode.Transparent,"Defaults");
Set("{\"radius\":32.5,\"edges\":\"Repeat\"}");Check(layer.radius==32.5f && layer.edges==DCFApixels.SpriteEditor.BlurLayerBehaviour.EdgeMode.Repeat,"Set parameters");
...
var copy=new DCFApixels.SpriteEditor.BlurLayerBehaviour();setter.Invoke(null,new object[]{copy,snapshot.Invoke(null,new object[]{layer})});
...
Check(DCFApixels.SpriteEditor.SpriteEditorApi.Describe().Contains("blurDefaults"),"Discovery");
