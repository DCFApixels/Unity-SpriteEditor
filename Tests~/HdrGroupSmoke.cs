...
try
{
    ...
    bright.colorRange = DCFApixels.SpriteEditor.LayerColorRange.Standard;
    Color limited = Pixel();
    ...
    Call(drawing, "SetColorRange", DCFApixels.SpriteEditor.LayerColorRange.HDR);
    ...
    Call(drawing, "SetColorRange", DCFApixels.SpriteEditor.LayerColorRange.Standard);
