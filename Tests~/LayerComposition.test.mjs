...
assert.match(read('Automation/SpriteEditorApi.LiveCompletion.cs'), /pending.AdoptContent\(candidate\)/);
assert.match(read('Automation/SpriteEditorApi.Inspect.cs'), /entry\["behaviourMissing"\] = layer.Behaviour == null/);
