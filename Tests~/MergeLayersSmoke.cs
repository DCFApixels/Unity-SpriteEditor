...
var documents = new List<DCFApixels.SpriteEditor.TextureCompositor>();
var owned = new List<UnityEngine.Object>();
int checks = 0;
void Check(bool condition, string message) { checks++; if (!condition) throw new Exception(message); }
DCFApixels.SpriteEditor.TextureCompositor Doc(params DCFApixels.SpriteEditor.Layer[] layers)
{
...
Color Pixel(DCFApixels.SpriteEditor.TextureCompositor doc)
{
...
try
{
    ...
    var bright = Fill(new Color(2, .2f, .3f, 1)); bright.colorRange = DCFApixels.SpriteEditor.LayerColorRange.HDR;
