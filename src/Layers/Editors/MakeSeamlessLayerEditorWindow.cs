...
namespace DCFApixels.SpriteEditor
{
    public sealed class MakeSeamlessLayerEditorWindow : LayerEditorWindowBase
    {
            ...
            Action<VisualElement, TargetedLayerEffect> addEffectTarget)
        {
            ...
            var horizontal = SpriteEditorUI.ConfigureField(new EnumField("Horizontal", layer.horizontal)
            ...
            root.Add(width);
            var falloff = SpriteEditorUI.ConfigureField(new Slider("Falloff", .25f, 4f)
            ...
            Action<string, Action> applyChange, SpriteEditorUI.ValueBindings bindings)
        {
            ...
            selector.AddToClassList("sprite-editor-seamless-edges");
            ...
            void AddEdge(string edge, string tooltip, Func<bool> selected, Action toggle)
            {
                ...
                button.AddToClassList("sprite-editor-seamless-edge");
                button.AddToClassList("sprite-editor-seamless-edge--" + edge);
                void Refresh() => button.EnableInClassList("sprite-editor-seamless-edge--selected", selected());
                Refresh();
        ...
        private sealed class SeamlessImageIcon : VisualElement
        {
            public SeamlessImageIcon()
            {
                ...
                AddToClassList("sprite-editor-seamless-image");
