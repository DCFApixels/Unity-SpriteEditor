...
namespace DCFApixels.SpriteEditor
{
    ...
    {
        private static void SetMakeSeamless(MakeSeamlessLayer layer, JObject value)
        {
        ...
        private static JObject MakeSeamlessSnapshot(MakeSeamlessLayer layer) => new JObject
        {
