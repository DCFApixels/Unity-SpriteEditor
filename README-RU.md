...
**Типы слоёв:** File · Drawing · Color Fill · Gradient · Outline · SDF · Normal Map · Gaussian Blur · Shader Processor · Group.
...
`Color Fill n`, `Gradient n`, `Outline n`, `SDF n`, `Normal Map n`, `Gaussian Blur n` и `Group n`.
