...
| Эффекты | Outline, SDF, Normal Map, режимы смешивания и встроенные Shader FX с редактируемым HLSL. |
...
**Типы слоёв:** File · Drawing · Color Fill · Gradient · Outline · SDF · Normal Map · Group.
...
`Color Fill n`, `Gradient n`, `Outline n`, `SDF n`, `Normal Map n` и `Group n`.
...
Слои эффектов (Outline, SDF и Normal Map) обрабатывают скрытые источники в режимах Previous
