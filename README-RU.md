...
| Эффекты | Outline, SDF, Normal Map, Gaussian Blur, режимы смешивания и встроенные Shader FX с редактируемым HLSL. |
...
**Типы слоёв:** File · Drawing · Color Fill · Gradient · Noise · Outline · SDF · Normal Map · Gaussian Blur · Shader Processor · Group.
...
`Color Fill n`, `Gradient n`, `Noise n`, `Outline n`, `SDF n`, `Normal Map n`, `Gaussian Blur n` и `Group n`.
...
Слои эффектов (Outline, SDF, Normal Map и Gaussian Blur) обрабатывают скрытые источники в режимах Previous
